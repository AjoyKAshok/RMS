...
Future<void> getProductDetails() async {
  http.Response PDresponse = await http.post(
    productdetails,
    headers: {
  ...
  if (PDresponse.statusCode == 200) {
    ...
    for (int u = 0; u < decodededproducts['data'].length; u++) {
      ...
      dynamic categoryofpdts =
          '${decodededproducts['data'][u]['category_name']}';
    ...
    print("products : ${productlist.productid.length }");
