    ...
    for (int u = 0; u < decodebrands['data'].length; u++) {
      if (decodebrands['data'][u]['store_code'] != null) {
        if (decodebrands['data'][u]['category_name'] != null) {
          ...
          mapping.outletname.add(
              '[${decodebrands['data'][u]['store_code']}] ${decodebrands['data'][u]['store_name'].toString()}');
          mapping.categoryname.add(decodebrands['data'][u]['category_name']);
          mapping.outletaddress
              .add(decodebrands['data'][u]['address'].toString());
          mapping.outletnumber
              .add(decodebrands['data'][u]['contact_number'].toString());
          ...
          mapping.pdfurl.add(
              "https://test.rhapsody.ae/nbl_file/${decodebrands['data'][u]['nbl_pdf']}");
        }
      }
    }
