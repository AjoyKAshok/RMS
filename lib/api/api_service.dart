...
Uri expectedvisitchart =
    Uri.parse("https://test.rhapsody.ae/api/outlet_expected_outlet_chart");
Uri OutletSurvey = Uri.parse("https://test.rhapsody.ae/api/add_outlet_survey");
Uri deltimesheet = Uri.parse("https://test.rhapsody.ae/api/delete_journeyplan");
Uri ShareofshelfDetails =
    Uri.parse("https://test.rhapsody.ae/api/share_of_shelf_details");
Uri PlanogramDetails =
    Uri.parse("https://test.rhapsody.ae/api/Planogram_details");
Uri getcompdetails =
    Uri.parse("https://test.rhapsody.ae/api/competition_details");
Uri VisibilityDetails =
    Uri.parse("https://test.rhapsody.ae/api/visibility_details");
Uri AddVisibility = Uri.parse("https://test.rhapsody.ae/api/add_visibility");
Uri AddPlanogram = Uri.parse("https://test.rhapsody.ae/api/add_planogram");
Uri ChartUrl = Uri.parse("https://test.rhapsody.ae/api/outlet_chart");
Uri Loginurl = Uri.parse("https://test.rhapsody.ae/api/login");
Uri DBdailyurl = Uri.parse("https://test.rhapsody.ae/api/dashboard_daily");
Uri DBmonthlyurl = Uri.parse("https://test.rhapsody.ae/api/dashboard_monthly");
Uri OCurl = Uri.parse("https://test.rhapsody.ae/api/outlet_details");
Uri CICOurl = Uri.parse("https://test.rhapsody.ae/api/check_in_out");
Uri attendancein = Uri.parse("https://test.rhapsody.ae/api/attendance_in");
Uri UpdateOutlet = Uri.parse("https://test.rhapsody.ae/api/update_outlet");
Uri TSurl = Uri.parse("https://test.rhapsody.ae/api/timesheet_daily");
Uri leaveurl = Uri.parse("https://test.rhapsody.ae/api/leave_request");
Uri empdataurl = Uri.parse("https://test.rhapsody.ae/api/employee_details");
Uri passwordchangeurl =
    Uri.parse("https://test.rhapsody.ae/api/change_password");
Uri taskdetailes =
    Uri.parse("https://test.rhapsody.ae/api/outlet_task_details");
Uri taskresponse =
    Uri.parse("https://test.rhapsody.ae/api/send_outlet_task_response");
Uri LDurl = Uri.parse("https://test.rhapsody.ae/api/leave_details");
Uri JPSkippedurl =
    Uri.parse("https://test.rhapsody.ae/api/today_skipped_journey");
Uri JPVisitedurl =
    Uri.parse("https://test.rhapsody.ae/api/today_completed_journey");
Uri JPurl = Uri.parse("https://test.rhapsody.ae/api/today_planned_journey");
Uri empdetailsurl =
    Uri.parse("https://test.rhapsody.ae/api/employee_details_for_report");
Uri reportingdataurl =
    Uri.parse("https://test.rhapsody.ae/api/reporting_to_details");
Uri addreportaurl = Uri.parse("https://test.rhapsody.ae/api/add_reporting");
Uri holidaysdataurl =
    Uri.parse("https://test.rhapsody.ae/api/holidays_details");
Uri addholidayurl = Uri.parse("https://test.rhapsody.ae/api/add_holidays");
Uri WJPPlannedurl =
    Uri.parse("https://test.rhapsody.ae/api/week_planned_journey");
Uri WJPSkippedurl =
    Uri.parse("https://test.rhapsody.ae/api/week_skipped_journey");
Uri WJPVisitedurl =
    Uri.parse("https://test.rhapsody.ae/api/week_completed_journey");
Uri TSMurl = Uri.parse("https://test.rhapsody.ae/api/timesheet_monthly");
Uri TSSplitMurl =
    Uri.parse("https://test.rhapsody.ae/api/timesheet_monthly_split_time");
Uri HRdburl = Uri.parse("https://test.rhapsody.ae/api/hr_dashboard");
Uri visitsurl = Uri.parse("https://test.rhapsody.ae/api/outlet_chart");
Uri MercNameList = Uri.parse(
    "https://test.rhapsody.ae/api/merchandiser_under_fieldmanager_details");
Uri Storedetailsurl = Uri.parse("https://test.rhapsody.ae/api/store_details");
Uri AddStoreurl = Uri.parse("https://test.rhapsody.ae/api/add_store");
Uri StoreDetailsurl = Uri.parse("https://test.rhapsody.ae/api/store_details");
Uri FMDashBoardurl =
    Uri.parse("https://test.rhapsody.ae/api/fieldmanager_dashboard");
Uri AddOutletsurl = Uri.parse("https://test.rhapsody.ae/api/add_outlet");
Uri overallJPurl = Uri.parse("https://test.rhapsody.ae/api/journey");
Uri MercLeaveDetails =
    Uri.parse("https://test.rhapsody.ae/api/merchandiser_leave_details");
Uri AddEmployee = Uri.parse("https://test.rhapsody.ae/api/add_employee");
Uri unschdulejp =
    Uri.parse("https://test.rhapsody.ae/api/add_unscheduled_journeyplan");
Uri designation = Uri.parse("https://test.rhapsody.ae/api/all_roles");
Uri schdulejp =
    Uri.parse("https://test.rhapsody.ae/api/add_scheduled_journeyplan");
Uri Attendance = Uri.parse("https://test.rhapsody.ae/api/attendance_monthly");
Uri updateemp = Uri.parse("https://test.rhapsody.ae/api/update_employee");
Uri LeaveacceptReject =
    Uri.parse("https://test.rhapsody.ae/api/leave_accept_reject");
Uri BrandDetails = Uri.parse("https://test.rhapsody.ae/api/brand_details");
Uri AddBrand = Uri.parse("https://test.rhapsody.ae/api/add_brand");
Uri CategoryDetails =
    Uri.parse("https://test.rhapsody.ae/api/category_details");
Uri AddCategory = Uri.parse("https://test.rhapsody.ae/api/add_category");
Uri AddProducts = Uri.parse("https://test.rhapsody.ae/api/add_product");
Uri productdetails = Uri.parse("https://test.rhapsody.ae/api/product_details");
Uri Addoutletbrandmap =
    Uri.parse("https://test.rhapsody.ae/api/add_outlet_brand_mapping");
Uri outletbrandmapping =
    Uri.parse("https://test.rhapsody.ae/api/outlet_brand_mapping_details");
Uri AvailabilityDetails =
    Uri.parse("https://test.rhapsody.ae/api/availability_details");
Uri AddAvailability =
    Uri.parse("https://test.rhapsody.ae/api/add_availability");
Uri CompetitionDetails =
    Uri.parse("https://test.rhapsody.ae/api/competition_details");
Uri AddCompetition = Uri.parse("https://test.rhapsody.ae/api/add_competition");
Uri Weekoffdetails = Uri.parse("https://test.rhapsody.ae/api/week_off_details");
Uri AddWeekoff = Uri.parse("https://test.rhapsody.ae/api/add_week_off");
Uri AddTaskList = Uri.parse("https://test.rhapsody.ae/api/add_outlet_task");
Uri GetTaskDetails =
    Uri.parse("https://test.rhapsody.ae/api/outlet_task_details");
Uri stockexpiryDetails =
    Uri.parse("https://test.rhapsody.ae/api/stock_product_details_new");
Uri addedstockexpiryDetails =
    Uri.parse("https://test.rhapsody.ae/api/stock_expiry_details_new");
Uri addexpiryDetail =
    Uri.parse("https://test.rhapsody.ae/api/add_stock_expiry_new");
Uri AddShareofshelf =
    Uri.parse("https://test.rhapsody.ae/api/add_share_of_shelf");
Uri MercViewUpdtPromo = Uri.parse(
    "https://test.rhapsody.ae/api/merchandiser_view_updated_promotion__details");
Uri MercAddPromotion = Uri.parse(
    "https://test.rhapsody.ae/api/merchandiser_add_promotion__details");
Uri PromoDetails = Uri.parse(
    "https://test.rhapsody.ae/api/fieldmanager_view_promotion_details");
Uri AddPromotion =
    Uri.parse("https://test.rhapsody.ae/api/fieldmanager_add_promotion");
Uri AddPlanoFM =
    Uri.parse("https://test.rhapsody.ae/api/fieldmanager_add_outlet_planogram");
Uri AddOutletMap = Uri.parse(
    "https://test.rhapsody.ae/api/fieldmanager_add_outlet_category_mapping");
Uri AddBrandOMap =
    Uri.parse("https://test.rhapsody.ae/api/outlet_brand_mapping_details");
Uri addoutletshareofshelf = Uri.parse(
    "https://test.rhapsody.ae/api/fieldmanager_add_outlet_shareofself");
Uri clientpromodataurl = Uri.parse(
    "https://test.rhapsody.ae/api/client_view_outlet_promotion_check_details");
Uri NBLDetailsFMs = Uri.parse(
    "https://test.rhapsody.ae/api/fieldmanager_view_outlet_nbl_details");
Uri clientoutletsurl =
    Uri.parse("https://test.rhapsody.ae/api/client_view_outlet_details");
Uri clientexpiryinfo = Uri.parse(
    "https://test.rhapsody.ae/api/client_view_outlet_stock_expirey_details");
Uri delcategorymapping =
    Uri.parse("https://test.rhapsody.ae/api/delete_outlet_products_mapping");
Uri FMAddNBL =
    Uri.parse("https://test.rhapsody.ae/api/fieldmanager_add_outlet_nbl");
Uri deactCL = Uri.parse("https://test.rhapsody.ae/api/de_active_outlet_task");
Uri actCL = Uri.parse("https://test.rhapsody.ae/api/active_outlet_task");
Uri MercBreak =
    Uri.parse("https://test.rhapsody.ae/api/outlet_journey_check_in_out");
Uri NotiDet =
    Uri.parse("https://test.rhapsody.ae/api/view_notification_details");
Uri NotiViewAll =
    Uri.parse("https://test.rhapsody.ae/api/make_notification_all_viewed");
Uri RelieverDet =
    Uri.parse("https://test.rhapsody.ae/api/view_reliver_details");
Uri searchReliever = Uri.parse("https://test.rhapsody.ae/api/search_reliver");
Uri AddReliever = Uri.parse("https://test.rhapsody.ae/api/add_reliver");
Uri NotiViewed =
    Uri.parse("https://test.rhapsody.ae/api/make_notification_viewed");
Uri TotalJnryTime =
    Uri.parse("https://test.rhapsody.ae/api/outlet_journey_time_details");
Uri ForceCIReason = Uri.parse("https://test.rhapsody.ae/api/add_force_checkin");
Uri Uploadfile = Uri.parse("https://test.rhapsody.ae/api/add_excel_report");
Uri downloadfile =
    Uri.parse("https://test.rhapsody.ae/api/excel_report_details");
Uri Logout = Uri.parse("https://test.rhapsody.ae/api/logout");
Uri Merchlistundercde =
    Uri.parse("https://test.rhapsody.ae/api/merchandiser_under_cde_details");
Uri CDEdashboard = Uri.parse("https://test.rhapsody.ae/api/cde_dashboard");
Uri CDEReportingDet =
    Uri.parse("https://test.rhapsody.ae/api/cde_reporting_to_details");
Uri AddReportCDE = Uri.parse("https://test.rhapsody.ae/api/add_cde");
Uri CDEApproveTimeSheet =
    Uri.parse("https://test.rhapsody.ae/api/cde_timesheet_approval");
Uri LeaveReportwithtype =
    Uri.parse("https://test.rhapsody.ae/api/leave_request");
Uri LeaveReportDetails = Uri.parse(
    "https://test.rhapsody.ae/api/leave_details_view_by_fieldmanager");
Uri FMViewOutletTaskDetails = Uri.parse(
    "https://test.rhapsody.ae/api/fieldmanager_view_outlet_task_response");
Uri LeaveRuleDetails =
    Uri.parse("https://test.rhapsody.ae/api/leave_rule_details");
Uri LeaveRuleUpdtae =
    Uri.parse("https://test.rhapsody.ae/api/update_leave_rule");
...
Future  outletOverAllJpWhencheckin(String outletid) async {
  ...
  print("outletOverAllJpWhencheckin....$outletid...ODrequestDataforcheckin..$ODrequestDataforcheckin");
  try{
...
Future  outletwhencheckin() async {
  ...
  try {
    ...
    print("offlineoutletdeatiles length... ${offlineoutletdeatiles.length}..$OCdata");
    var decodeODData = jsonDecode(OCdata);
    print(decodeODData);
    chekinoutlet.checkinoutletid =
        decodeODData['data'][0]['store'][0]["store_code"];
    ...
    chekinoutlet.currentdistance = Geolocator.distanceBetween(
        ...
        double.parse(chekinoutlet.checkinlong));
    getchartdetails();
    print("lat....$lat..long..$long..${chekinoutlet.checkinlat}..${chekinoutlet.checkinlong}...${chekinoutlet.currentdistance}");
...
void addattendence() async {
      ...
      on SocketException catch (_)
  {
    ...
    adddataforsync(
        "https://test.rhapsody.ae/api/attendance_in", jsonEncode(data), "");
  }
...
print("checkin...$checkinoutresponse");
      ...
      on SocketException catch (_) {
        ...
        adddataforsync(
            "https://test.rhapsody.ae/api/check_in_out",
...
Future getTaskList() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      await saveActivitiesDataIntoDB(currenttimesheetid.toString(), tasklistbody, checklistdetaildata_table);
  ...
  on SocketException catch (_) {
    print("getTaskList");
    String checklistdata = await getActivityData(checklistdetaildata_table, currenttimesheetid.toString());
    ...
    if(checklistdata!=null)
    {
      ...
      task.id = [];
      task.iscompleted = [];
      print("offlinechecklistdata leeength ...${offlinechecklistdata.length}....index...$currentoutletindex");
      print("not null");
...
Future sendtaskresponse(bool connection) async {
  ...
  print(jsonEncode(taskbody));
      ...
      on SocketException catch (_) {
        ...
        adddataforsync(
            "https://test.rhapsody.ae/api/send_outlet_task_response",
            jsonEncode(taskbody),
...
Future merchbreak() async {
  ...
  print("merchbreak...${jsonEncode(breaktime)}");
      ...
      try {
        ...
        adddataforsync(
          "https://test.rhapsody.ae/api/outlet_journey_check_in_out",
  ...
  Map forceci = {
    ...
    "reason":
      ...
      on SocketException catch (_) {
        ...
        adddataforsync(
            "https://test.rhapsody.ae/api/add_force_checkin",
            jsonEncode(forceci),
  ...
  Map outsvy = {
    ...
    "stockexpiry": OutletSurveySubmit.stockexpiry,
      ...
      on SocketException catch (_) {
        ...
        adddataforsync("https://test.rhapsody.ae/api/add_outlet_survey",
    ...
    for (int u = 0; u < decodeODData['data'].length; u++) {
      ...
      if ((decodeODData['data'][u]['img_url']) != null) {
        ...
        fmviewtaskdata.url.add(
            "https://test.rhapsody.ae/task_file/${decodeODData['data'][u]['img_url']}");
