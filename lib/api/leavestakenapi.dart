...
Future<void> leaveData() async {
  ...
  try {
    ...
    print("leaveData...${LDresponse.body}");
...
Future<void> gettimesheetleavetype() async {
  ...
  print(bodyfm);
  try {
    http.Response dataresponse1 = await http.post(
      LeaveReportDetails,
      headers: {
        'Content-Type': 'application/json',
        'Accept': 'application/json',
    ...
    if (dataresponse1.statusCode == 200) {
      ...
      for (int u = 0; u < decodeData['data'].length; u++) {
        ...
        print(date);
        if (dataofdates1.contains(date)) {} else {
          dataofdates1.add(date);
          dataofdates1.sort();
        }

        if (date == listOfDatesapi1[1 - 1]) {
          TMmonthly1.day1
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[2 - 1]) {
          TMmonthly1.day2
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[3 - 1]) {
          TMmonthly1.day3
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[4 - 1]) {
          TMmonthly1.day4
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[5 - 1]) {
          TMmonthly1.day5
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[6 - 1]) {
          TMmonthly1.day6
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[7 - 1]) {
          TMmonthly1.day7
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[8 - 1]) {
          TMmonthly1.day8
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        // TMmonthly1.day7.add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        // TMmonthly1.day8.add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        if (date == listOfDatesapi1[9 - 1]) {
          TMmonthly1.day9
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[10 - 1]) {
          TMmonthly1.day10
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[11 - 1]) {
          TMmonthly1.day11
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[12 - 1]) {
          TMmonthly1.day12
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        print(TMmonthly1.day12);
        if (date == listOfDatesapi1[13 - 1]) {
          TMmonthly1.day13
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        print(TMmonthly1.day13);
        if (date == listOfDatesapi1[14 - 1]) {
          TMmonthly1.day14
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        print(TMmonthly1.day14);
        if (date == listOfDatesapi1[15 - 1]) {
          TMmonthly1.day15
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[16 - 1]) {
          TMmonthly1.day16
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[17 - 1]) {
          TMmonthly1.day17
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[18 - 1]) {
          TMmonthly1.day18
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[19 - 1]) {
          TMmonthly1.day19
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[20 - 1]) {
          TMmonthly1.day20
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[21 - 1]) {
          TMmonthly1.day21
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[22 - 1]) {
          TMmonthly1.day22
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[23 - 1]) {
          TMmonthly1.day23
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[24 - 1]) {
          TMmonthly1.day24
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[25 - 1]) {
          TMmonthly1.day25
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[26 - 1]) {
          TMmonthly1.day26
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[27 - 1]) {
          TMmonthly1.day27
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (date == listOfDatesapi1[28 - 1]) {
          TMmonthly1.day28
              .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
        }
        if (listOfDatesapi1.length > 28) {
          if (date == listOfDatesapi1[28]) {
            TMmonthly1.day29
                .add('{"Leavetype": "${decodeData['data'][u]['leavetype']}"}');
          }
        }
