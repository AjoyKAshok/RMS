...
Future<void> getJourneyPlanweekly() async {
  ...
  JPweekly = await getData(journeyplanweekly_table);
  print("JPweekly^^^^$JPweekly");
    ...
    if (JPresponse.statusCode == 200) {
      ...
      currentuser.roleid == 5
          ...
          : currentuser.roleid == 2
              ? print("journey plan done for merch under CDE")
              : print("");
      JPweekly = JPresponse.body;
     // await plannedjpweekly(JPweekly);
      print("getJourneyPlanweekly... online...$JPweekly");
      await saveDataIntoDB(JPweekly,journeyplanweekly_table);
  ...
  // else {
      if(JPweekly != null) {
        print("getJourneyPlanweekly... offline...$JPweekly");
        getweeklyjp.sundaystorenames = [];
        getweeklyjp.mondaystorenames = [];
        getweeklyjp.tuesdaystorenames = [];
        getweeklyjp.wednesdaystorenames = [];
