...
Future HRdb() async {
  ...
  if (DBresponse.statusCode == 200) {
    ...
    HRdashboarddata.emptotal =
        HRdashboarddata.fmtotal + HRdashboarddata.merchtotal;
    HRdashboarddata.emppresent =
        HRdashboarddata.fmpresent + HRdashboarddata.merchpresent;
    HRdashboarddata.empabsent =
        HRdashboarddata.fmabsent + HRdashboarddata.merchabsent;
