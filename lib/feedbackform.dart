...
class FormController {
  ...
  Uri URL = Uri.parse(
      "https://script.google.com/macros/s/AKfycbyqQHi2CL5JDzdM4MO1WiXmNDawmYnQs72i52hJH9uC4kD2hyS0/exec");
...
class _MyHomePageState extends State<FeedbackPage> {
  ...
  void _submitForm() {
    ...
    if (_formKey.currentState.validate()) {
      ...
      FeedbackForm feedbackForm = FeedbackForm("${DBrequestdata.receivedempid}",
          nameController.text, "${DateTime.now()}", feedbackController.text);
