    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 5),
          Text(
              'Date : ${ClientOutlets.lastvisiteddate[indexclientselected].toString()}'),
          SizedBox(height: 5),
          Text(
              'Visit Type : ${ClientOutlets.isschedulevisit[indexclientselected].toString() == "1" ? "Scheduled" : "UnScheduled"}'),
          SizedBox(height: 5),
          Text(
              'Checkin Time : ${ClientOutlets.checkintime[indexclientselected].toString()}'),
          SizedBox(height: 5),
          Text(
              'Checkout Time : ${ClientOutlets.checkouttime[indexclientselected].toString()}'),
          SizedBox(height: 5),
          Text(
              'Checkin Location : ${ClientOutlets.checkinlocation[indexclientselected].toString()}'),
          SizedBox(height: 5),
          Text(
              'Checkout Location : ${ClientOutlets.checkoutlocation[indexclientselected].toString()}'),
          SizedBox(height: 5),
          Text(
              'Visited By : ${ClientOutlets.merchandiserid[indexclientselected].toString()}'),
        ],
      ),
    );
  }
...
class _ActivitesSelectorState extends State<ActivitesSelector> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        widget.activityname,
        style: TextStyle(color: widget.ontap ? pink : orange, fontSize: 16),
      ),
    );
  }
}
      ...
      children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: pressAttentionMTB == true ? orange : Colors.white,
                ),
              ),
            ),
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: pressAttentionTODAY == true ? orange : Colors.white,
                ),
              ),
            ),
            Spacer(),
        ...
        Expanded(
          child: ListView.builder(
              ...
              // shrinkWrap: true,
              itemCount: pressAttentionMTB
                  ? Avaiablity.insreason.length
                  : Avaiablity.oosreason.length,
                        ...
                        children: [
                          SingleChildScrollView(
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                // width: pressAttentionMTB
                                //     ? MediaQuery.of(context).size.width / 1.25
                                //     : MediaQuery.of(context).size.width / 1.6,
                                  child: pressAttentionMTB
                                      ? Text(Avaiablity.insreason[index])
                                      : Text(Avaiablity.oos[index],textAlign: TextAlign.start,)),
                            ),
                          ),
                          Spacer(),
                          pressAttentionMTB
                              ...
                              : Padding(
                              padding: const EdgeInsets.only(top: 5.0),
                              child: Text(Avaiablity.oosreason[index],textAlign: TextAlign.start,))
                        ],
                      ),
                    // ),
                    Divider(
        ...
        ShareData.actualpercent.length != 0
            ? Expanded(
                child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return ShareData.actualpercent.toString() != "[null]"
                          ? Column(
                              children: [
                                Table(
                                  columnWidths: {
                                  ...
                                  children: [
                                    TableRow(children: [
                                      ...
                                      Center(
                                          child: Text(
                                              "${ShareData.target[index]} %")),
                                      Center(
                                          child: Text(ShareData
                                                      .actualpercent[index] !=
                                                  null
                                              ? '${ShareData.share[index]==""?"0":ShareData.share[index]} m'
                                              : "No Data")),
                                      Center(
                                          child: Text(ShareData
                                                      .actualpercent[index] !=
                                                  null
                                              ? '${double.parse(ShareData.actualpercent[index]).toStringAsFixed(0)} %'
                                              : "No Data")),
                                    ])
                                  ],
                                ),
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                          PreveiwScreen(
                                            input:
                                                PlanoDetails.beforeimage[index],
                                          )));
                            },
                            child: Center(
                              child: Container(
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(bottom: 5.0, top: 10.0),
                child: Text(
                  pressAttentionTODAY ? "Reason" : "Image",
                  style: TextStyle(color: orange, fontSize: 16),
                ),
              ),
            ],
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  width:
                                      MediaQuery.of(context).size.width / 1.6,
                                  child:
                                      Text(ClientPromo.productNameoos[index]),
                                ),
                              ),
                            ...
                            GestureDetector(
                              ...
                              child: SizedBox(
                                ...
                                child: PhotoView(
                                  ...
                                  imageProvider:
                                      NetworkImage(ClientPromo.imageUrl[index]),
                                ),
                              ),
                            ),
                          ],
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "${CompetitionData.itemname[index]}",
                              style: TextStyle(color: orange, fontSize: 16),
                            ),
                            Text(
                                "Company : ${CompetitionData.companyname[index]}"),
                            Text(
                                "Category : ${CompetitionData.brandname[index]}"),
                            Text(
                                "Regular Price :${CompetitionData.mrp[index].toString()} AED"),
                            Text(
                                "Selling Price : ${CompetitionData.sellingprice[index].toString()} AED"),
                            Text(
                                "Promotion type : ${CompetitionData.promotype[index].toString()}"),
                            Text(
                                "Promotion description : ${CompetitionData.promodesc[index].toString()}"),
                          ],
                        ),
                      ),
                      GestureDetector(
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (BuildContext context) =>
                                      PreveiwScreen(
                                        input:
                                            CompetitionData.captureimg[index],
                                      )));
                        },
                        child: Padding(
                      ...
                      children: [
                        TableRow(children: [
                          Padding(
                            padding: const EdgeInsets.only(top: 40.0),
                            child: Text(
                                "${fmviewtaskdata.list[index].toString()}"),
                          ),
                          // GestureDetector(
                          //   onTap: (){
                          //     Navigator.push(
                            ...
                            child: Center(
                              child: Container(
                                ...
                                child: PhotoView(
                                  ...
                                  imageProvider:
                                      NetworkImage(fmviewtaskdata.url[index]),
                                ),
                              ),
                            ),
                          ),
                        ...
                        children: [
                          ...
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                Text(
                                  "${Stockdata.productname[index]} [${Stockdata.zrepcode[index]}]",
                          ...
                          Text(
                              "Expiry Date : ${Stockdata.expirydate[index].toString()}"),
                          Text(
                              "Price : ${Stockdata.pieceperprice[index].toString()} AED"),
                          Text(
                              "Near to Expiry : ${Stockdata.nearexpiry[index].toString()}"),
                          Text(
                              "Value : ${Stockdata.nearexpiryvalue[index].toString()} AED"),
                          Text(
                              "Exposure Quantity : ${Stockdata.exposurequantity[index].toString()}"),
                          Text(
                              "Estimated Expiry Value : ${Stockdata.estimateexpiryvalue[index].toString()} AED"),
                          Text(
                              "Captured Period : P${Stockdata.period[index]}"),
                          Text(
                              "Expiry Period : P${Stockdata.expiryperiod[index] == null ? "3" : Stockdata.expiryperiod[index]}"),
                          Text(
                              "Remarks : ${Stockdata.remarks[index].toString()}"),
                          Text(
                              "Captured By : ${Stockdata.capturedby[index].toString()}"),
                        ],
                      ),
                    ),
                  ),
