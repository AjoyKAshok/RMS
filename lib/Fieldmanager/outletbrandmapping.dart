            ...
            return GestureDetector(
                onTap: () async {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (BuildContext context) => MappedOutlets()));
                },
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text(
                            'Contact Number : ${outletdata.contactnumber[index].toString()}'),
                        SizedBox(height: 5),
                        Text(
                            'Location : ${outletdata.outletarea[index]},${outletdata.outletcity[index]},${outletdata.outletstate[index]},${outletdata.outletcountry[index]}',
                            style: TextStyle(
                              fontSize: 14.0,
                            )),
                      ],
            ...
            return GestureDetector(
                onTap: () async {
                  ...
                  Selectedoutletaddress =
                      outletdata.address[_filterindex[index]];
                  Selectedoutletcontactnumber =
                      outletdata.contactnumber[_filterindex[index]];
                  print(Selectedoutlet);
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                ...
                child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 5),
                        Text(
                            'Contact Number : ${outletdata.contactnumber[_filterindex[index]].toString()}'),
                        SizedBox(height: 5),
                        Text(
                            'Location : ${outletdata.outletarea[_filterindex[index]]},${outletdata.outletcity[_filterindex[index]]},${outletdata.outletstate[_filterindex[index]]},${outletdata.outletcountry[_filterindex[index]]}',
                            style: TextStyle(
                              fontSize: 14.0,
                            )),
                      ],
              ...
              child: Column(
                children: [
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return Selectedoutlet == mapping.outletname[index]
                            ? Container(
                                padding: EdgeInsets.all(10.0),
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5),
                                        Text(
                                            'SOS Target : ${mapping.target[index]}%',
                                            style: TextStyle(
                                              fontSize: 14.0,
                                            )),
                                        // Row(
                                                        ...
                                                        builder: (context) {
                                                          ...
                                                          return Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                "Do you want to remove this category for the outlet",
                                                                textAlign:
                                                                    TextAlign
                                                                        .center,
                                                              ),
...
class VeiwImage extends StatelessWidget {
  String url = "https://test.rhapsody.ae/planogram_image/$Selectedimage";
