...
var selectedweekoff;
List outlets = outletdata.outletname.map((String val) {
...
class _AddJourneyPlanState extends State<AddJourneyPlan> {
  ...
  List outlets = outletdata.outletname_notempty.map((String val) {
  ...
  void initState() {
    ...
    print("JOURNEY PLAN..${outlets.length}");
  }
                                ...
                                child: SearchableDropdown.single(
                                  ...
                                  onChanged: (value) {
                                    setState(() {
                                      ...
                                      int id = currentuser.roleid == 5
                                          ? int.parse(selectedmerchandiser
                                              .replaceAll(RegExp('[^0-9]'), ''))
                                          : int.parse(
                                              selectmerchundercde.replaceAll(
                                                  RegExp('[^0-9]'), ''));
                                      print(id);
                              ...
                              Align(
                                ...
                                child: GestureDetector(
                                    onTap: () async {
                                      ...
                                      addschdulejp.days = [];
                                      print("selectedmonth...$selectedmonth..selectedweekday...$selectedweekday");
                                      if (pressschdlue == true) {
                                        if (selectedoutlets != null &&
                                          ...
                                          for (int u = 0;
                                              u < selectedoutlets.length;
                                              u++) {
                                            addunschdulejp.outletid.add(
                                                outletdata.outletid[
                                                    selectedoutlets[u]]);
                                            addschdulejp.outletid.add(outletdata
                                                .outletid[selectedoutlets[u]]);
                                          }
                                            ...
                                            for (int u = 0;
                                                u <
                                                    merchnamelist
                                                        .firstname.length;
                                                u++) {
                                              if (merchnamelist.firstname[u] ==
                                                  selectedmerchandiser) {
                                                addunschdulejp.empid =
                                                    merchnamelist.employeeid[u];
                                                addschdulejp.empid =
                                                    merchnamelist.employeeid[u];
                                              }
                                            }
                                            ...
                                            for (int u = 0;
                                                u <
                                                    MerchUnderCDE
                                                        .firstname.length;
                                                u++) {
                                              if (MerchUnderCDE.firstname[u] ==
                                                  selectedmerchandiser) {
                                                addunschdulejp.empid =
                                                    MerchUnderCDE.employeeid[u];
                                                addschdulejp.empid =
                                                    MerchUnderCDE.employeeid[u];
                                              }
                                            }
                                          ...
                                          for (int u = 0;
                                              u < selectedweekday.length;
                                              u++) {
                                            addschdulejp.days.add(
                                                "${weekdays[selectedweekday[u]]}");
                                          }
                                          setState(() {
                                          ...
                                          Flushbar(
                                            message: selectedmerchandiser == null
                                                    ? "Merchandiser cannot be empty"
                                                    : currentuser.roleid!=5&&selectmerchundercde ==
                                                            null
                                                        ? "Merchandiser cannot be empty": selectedoutlets == null
                                                ? "Outlet Should not be Empty"
                                        ...
                                        if (selectedoutlets != null &&selecteddate != null&&
                                                currentuser.roleid == 5
                                            ? selectedmerchandiser != null
                                            : selectmerchundercde != null
                                                ) {
  ...
  Widget _createListView() {
    return new Flexible(
      child: new ListView.builder(
          // shrinkWrap: true,
          itemCount: currentuser.roleid == 5
              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                          currentuser.roleid == 5
                              ? 'Merchandiser : ${merchnamelist.name[index]} ${merchnamelist.surname[index]}'
              ...
              child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                          currentuser.roleid == 5
                              ? 'Merchandiser : ${merchnamelist.name[_filterList[index]]}'
...
List month = months.map((String val) {
  return new DropdownMenuItem<String>(
    value: val,
    child: new Text(val),
  );
}).toList();
List weekday = weekdays.map((String val) {
  return new DropdownMenuItem<String>(
    value: val,
    child: new Text(val),
  );
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.sundaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    SingleChildScrollView(
                                                      scrollDirection:
                                                          Axis.horizontal,
                                                      child: Text(
                                                        '${getweeklyjp.sundaystorenames[index].toString().replaceAll("null", "")}',
                                                        style: TextStyle(
                                                            fontSize: 15.0,
                                                            fontWeight:
                                                                FontWeight
                                              ...
                                              SingleChildScrollView(
                                                scrollDirection:
                                                    Axis.horizontal,
                                                child: Text(
                                                    '${getweeklyjp.sundayaddress[index].toString().replaceAll("null", "---")}',
                                                    style: TextStyle(
                                                      fontSize: 15.0,
                                                    )),
                                              ),
                                              ...
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.sundaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.mondaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    Text(
                                                      '${getweeklyjp.mondaystorenames[index].toString().replaceAll("null", "")}',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                              ...
                                              SizedBox(height: 5),
                                              Text(
                                                  '${getweeklyjp.mondayaddress[index].toString().replaceAll("null", "---")}',
                                                  style: TextStyle(
                                                    fontSize: 15.0,
                                                  )),
                                              SizedBox(height: 5),
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.mondaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
                          ...
                          children: [
                            ...
                            tuesdaytapped == true
                                ? ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        getweeklyjp.tuesdayaddress.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return GestureDetector(
                                        onTap: () async {},
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.tuesdaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    Text(
                                                      '${getweeklyjp.tuesdaystorenames[index].toString().replaceAll("null", "")}',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                              ...
                                              SizedBox(height: 5),
                                              Text(
                                                  '${getweeklyjp.tuesdayaddress[index].toString().replaceAll("null", "---")}',
                                                  style: TextStyle(
                                                    fontSize: 15.0,
                                                  )),
                                              SizedBox(height: 5),
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.tuesdaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
                          ...
                          children: [
                            ...
                            wednesdaytapped == true
                                ? ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        getweeklyjp.wednesdayaddress.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return GestureDetector(
                                        onTap: () async {},
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.wednesdaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    Text(
                                                      '${getweeklyjp.wednesdaystorenames[index].toString().replaceAll("null", "")}',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                              ...
                                              SizedBox(height: 5),
                                              Text(
                                                  '${getweeklyjp.wednesdayaddress[index].toString().replaceAll("null", "---")}',
                                                  style: TextStyle(
                                                    fontSize: 15.0,
                                                  )),
                                              SizedBox(height: 5),
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.wednesdaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
                          ...
                          children: [
                            ...
                            thursdaytapped == true
                                ? ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        getweeklyjp.thrusdayaddress.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return GestureDetector(
                                        onTap: () async {},
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.thrusdaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    Text(
                                                      '${getweeklyjp.thrusdaystorenames[index].toString().replaceAll("null", "")}',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                              ...
                                              SizedBox(height: 5),
                                              Text(
                                                  '${getweeklyjp.thrusdayaddress[index].toString().replaceAll("null", "---")}',
                                                  style: TextStyle(
                                                    fontSize: 15.0,
                                                  )),
                                              SizedBox(height: 5),
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.thrusdaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.fridaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    Text(
                                                      '${getweeklyjp.fridaystorenames[index].toString().replaceAll("null", "")}',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                              ...
                                              SizedBox(height: 5),
                                              Text(
                                                  '${getweeklyjp.fridayaddress[index].toString().replaceAll("null", "---")}',
                                                  style: TextStyle(
                                                    fontSize: 15.0,
                                                  )),
                                              SizedBox(height: 5),
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.fridaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
                          ...
                          children: [
                            ...
                            saturdaytapped == true
                                ? ListView.builder(
                                    ...
                                    shrinkWrap: true,
                                    itemCount:
                                        getweeklyjp.saturdaystorenames.length,
                                    itemBuilder:
                                        (BuildContext context, int index) {
                                      return GestureDetector(
                                        onTap: () async {},
                                            ...
                                            children: [
                                              SingleChildScrollView(
                                                ...
                                                child: Row(
                                                  children: [
                                                    Text(
                                                      '[${getweeklyjp.saturdaystorecodes[index].toString().replaceAll("null", "")}]',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                                    ...
                                                    Text(
                                                      '${getweeklyjp.saturdaystorenames[index].toString().replaceAll("null", "")}',
                                                      style: TextStyle(
                                                          fontSize: 15.0,
                                                          fontWeight:
                                                              FontWeight.bold),
                                              ...
                                              SizedBox(height: 5),
                                              Text(
                                                  '${getweeklyjp.saturdayaddress[index].toString().replaceAll("null", "---")}',
                                                  style: TextStyle(
                                                    fontSize: 15.0,
                                                  )),
                                              SizedBox(height: 5),
                                              Table(
                                                children: [
                                                  TableRow(children: [
                                                    ...
                                                    Text(
                                                        '${getweeklyjp.saturdaycontactnumbers[index].toString().replaceAll("null", "0")}',
                                                        style: TextStyle(
                                                            color: orange)),
                                                  ]),
                                                ],
