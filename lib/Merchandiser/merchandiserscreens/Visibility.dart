...
class _VisibilityOneState extends State<VisibilityOne> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                await addVisibilitydata(connection);
                setState(() {
                  isApiCallProcess = false;
                });
                Navigator.push(
  ...
  Widget _createListView() {
    if (VisibilityData.categoryname.length > 0)
      return new Flexible(
                        ...
                        Expanded(
                          child: Table(
                            ...
                            children: [
                              ...
                              if (VisibilityData.categoryname.length ==
                                  gareatextfeild.length)
                                TableRow(children: [
                                  Container(
                                    width:
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      // addMain=[];
                                      // addPOI=[];
                                      if (poistextfeild[index]
                                                  .text
                                                  .trim()
                                                  .length <=
                                              0 ||
                                          mainaisletextfeild[index]
                                                  .text
                                                  .trim()
                                                  .length <=
                                              0 ||
                                          gareatextfeild[index]
                                                  .text
                                                  .trim()
                                                  .length <=
                                              0) {
                                        ...
                                        setState(() {
                                          addGarea[index]
                                              .add(gareatextfeild[index].text);
                                          addmainaisle[index].add(
                                              mainaisletextfeild[index].text);
                                          addpois[index]
                                              .add(poistextfeild[index].text);
  ...
  Widget _performSearch() {
    print(
        "CAT length...${VisibilityData.categoryname.length}....${gareatextfeild.length}");
    _filterList = [];
    _filterindex = [];
    _filtergareatextfeild = [];
    _filtermainaisletextfeild = [];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(bottom: 5.0, left: 10.0),
                    child: Text(
                      "Add number of Stand off Shelf's :",
                      style: TextStyle(color: orange, fontSize: 15),
                    ),
                  ),
                  Row(
                    ...
                    children: [
                            ...
                            TableRow(children: [
                              Container(
                                ...
                                child: TextFormField(
                                  keyboardType: TextInputType.number,
                                  controller:
                                      gareatextfeild[_filterindex[index]],
                                  cursorColor: grey,
                                  textAlign: TextAlign.center,
                                  validator: (input) => !input.isNotEmpty
                                      ? "g-area should not be empty"
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  keyboardType: TextInputType.number,
                                  controller:
                                      mainaisletextfeild[_filterindex[index]],
                                  cursorColor: grey,
                                  validator: (input) => !input.isNotEmpty
                                      ? "main_aisle should not be empty"
                                      : null,
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  ...
                                  keyboardType: TextInputType.number,
                                  controller:
                                      poistextfeild[_filterindex[index]],
                                  cursorColor: grey,
                                  validator: (input) => !input.isNotEmpty
                                      ? "pois should not be empty"
                                      : null,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              if (poistextfeild[_filterindex[index]]
                                          .text
                                          .trim()
                                          .length <=
                                      0 ||
          ...
          SizedBox(
            ...
            child: Column(
              children: [
                ...
                Switch(
                  value: checkvaluevisibility[widget.indexrunning] == 0
                      ? true
                      : false,
                  onChanged: (value) {
                    setState(() {
                      if (value) {
                        dropdownreasons[widget.indexrunning] =
                            dropdownreasons[widget.indexrunning] ?? "";
                        visibilityreasons[widget.indexrunning] =
                            dropdownreasons[widget.indexrunning] ?? "";
                      } else {
                        visibilityreasons[widget.indexrunning] =
                            imagereasons[widget.indexrunning] ?? "";
                      }
                      print(
                          "isSwitchedVisi...$isSwitchedVisi..${visibilityreasons[widget.indexrunning]}...$value");
                      isSwitchedVisi = value;
                      isSwitchedVisi == true
                          ? checkvaluevisibility[widget.indexrunning] = 0
                          : checkvaluevisibility[widget.indexrunning] = 1;
...
List listofreasons =
    ["Item Expired", "Pending Delivery", "Out Of Stock"].map((String val) {
...
class _ReasonDropdownState extends State<ReasonDropdown> {
  ...
  void initState() {
    ...
    print(
        "from _ReasonDropdownState...${widget.item}...${visibilityreasons[widget.item]}");
  }
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: DropdownButton(
          ...
          iconSize: 35.0,
          value: dropdownreasons[widget.item] == ""
              ? null
              : dropdownreasons[widget.item],
          onChanged: (newVal) {
            setState(() {
              selectedreason = newVal;

              visibilityreasons[widget.item] = newVal;
              dropdownreasons[widget.item] = newVal;
                  ...
                  GestureDetector(
                    onTap: () async {
                      ...
                      if (picked != null) {
                        ...
                        print("PATH....${picked.files.single.path}");
                        final extension = p.extension(picked.files.single.path);
