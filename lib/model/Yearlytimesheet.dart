...
Future<void> getSelectedtimesheetmonthly() async {
  var listOfDatesapi = new List<String>.generate(
      daysInMonthyearly(DateTime(
          int.parse(DateFormat('yyyy').format(selectedDate)),
          int.parse(DateFormat('mm').format(selectedDate)))),
      (i) =>
          "${int.parse(DateFormat('yyyy').format(selectedDate))}-${DateFormat('MM').format(selectedDate)}-${'${i + 1}'.toString().padLeft(2, "0")}");
  ...
  if (dataresponse.statusCode == 200) {
    ...
    for (int u = 0; u < decodeData['data'].length; u++) {
      ...
      if (date == listOfDatesapi[2 - 1]) {
        SelectedTMmonthly.day2.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[3 - 1]) {
        SelectedTMmonthly.day3.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[4 - 1]) {
        SelectedTMmonthly.day4.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[5 - 1]) {
        SelectedTMmonthly.day5.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[6 - 1]) {
        SelectedTMmonthly.day6.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[7 - 1]) {
        SelectedTMmonthly.day7.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[8 - 1]) {
        SelectedTMmonthly.day8.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[9 - 1]) {
        SelectedTMmonthly.day9.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[10 - 1]) {
        SelectedTMmonthly.day10.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[11 - 1]) {
        SelectedTMmonthly.day11.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[12 - 1]) {
        SelectedTMmonthly.day12.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[13 - 1]) {
        SelectedTMmonthly.day13.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[14 - 1]) {
        SelectedTMmonthly.day14.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[15 - 1]) {
        SelectedTMmonthly.day15.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[16 - 1]) {
        SelectedTMmonthly.day16.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[17 - 1]) {
        SelectedTMmonthly.day17.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[18 - 1]) {
        SelectedTMmonthly.day18.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[19 - 1]) {
        SelectedTMmonthly.day19.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[20 - 1]) {
        SelectedTMmonthly.day20.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[21 - 1]) {
        SelectedTMmonthly.day21.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[22 - 1]) {
        SelectedTMmonthly.day22.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[23 - 1]) {
        SelectedTMmonthly.day23.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[24 - 1]) {
        SelectedTMmonthly.day24.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[25 - 1]) {
        SelectedTMmonthly.day25.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[26 - 1]) {
        SelectedTMmonthly.day26.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[27 - 1]) {
        SelectedTMmonthly.day27.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (date == listOfDatesapi[28 - 1]) {
        SelectedTMmonthly.day28.add(
            '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
      }
      if (listOfDatesapi.length > 28) {
        if (date == listOfDatesapi[28]) {
          SelectedTMmonthly.day29.add(
              '{"Outlet": "${decodeData['data'][u]['store_name']}","CheckIn":"${decodeData['data'][u]['checkin_time']}","CheckOut":"${decodeData['data'][u]['checkout_time']}"}');
        }
      }
      ...
      children: [
        Padding(
          ...
          child: Text(
            ...
            style: TextStyle(
                fontSize: 16, color: iconscolor, fontWeight: FontWeight.bold),
          ),
        ),
        // GestureDetector(
        //   onTap: (){
