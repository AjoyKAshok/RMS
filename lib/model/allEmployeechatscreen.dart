            ...
            Stack(
              children: [
                Container(
                  ...
                  child: Text(
                    'TO : Rhapsody Merchandising Services',
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              GestureDetector(
                                                                                ...
                                                                                child: Icon(
                                                                                  allmerchselected == true ? CupertinoIcons.check_mark_circled_solid : CupertinoIcons.xmark_circle_fill,
                                                                                  color: allmerchselected == true ? orange : Colors.grey,
                                                                                  size: 30,
                                                                                ),
                                                                              ),
                                                                            ],
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child: new ListView.builder(
                                                                              ...
                                                                              itemCount: currentuser.roleid == 5 ? merchnamelist.name.length : MerchUnderCDE.name.length,
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets
                                                        ...
                                                        0, 8.0, 0, 8.0),
                                                    child: Text(
                                                      employees.empid.indexOf(
                                                          messagesender)==-1?"Deleted User": employees.fullname[
                                                          employees.empid.indexOf(
                                                              messagesender)],
                                                      softWrap: true,
                                                      style: TextStyle(
