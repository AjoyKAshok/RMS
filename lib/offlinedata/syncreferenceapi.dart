 ...
 getalljpoutletsdata() async {
  ...
  for (int i = 0; i < gettodayjp.outletids.length; i++) {
    ...
    if (OCresponse.statusCode == 200) {
      ...
      await saveListDataIntoDb(OCresponse.body.toString(),alljpoutlets_table);
    }}
  ...
  for (int i = 0; i < gettodayjp.outletids.length; i++) {
    ...
    try {
      ...
      if (OCResponse.statusCode == 200) {
       ...
       await saveListDataIntoDb(OCResponse.body.toString(),alljpoutletschart_table);
      }
    }
    on SocketException catch (_) {
      return false;
  ...
  for (int i = 0; i < gettodayjp.outletids.length; i++) {
    ...
    try {
      ...
      if (OCResponse.statusCode == 200) {
       ...
       await saveListDataIntoDb(OCResponse.body.toString(),alljpoutletsEchart_table);
      }
    }
    on SocketException catch (_) {
      return false;
